...
<body>
	...
	<div id="box" class="inner">
		<h2 id="title" class="text-center">게시글 수정</h2>
		...
		<form>
			...
			<table class="table">
				...
				<tr>
					<th>제 목</th>
					<td>
						<input name="subject" type="text" class="search" style="width: 100%;" value="${vo.subject}">
					</td>
				</tr>
				...
				<tr>
					<th>내 용</th>
					<td>
						<TEXTAREA NAME='content' rows="9" cols="65" style="width: 100%; resize:none;">${vo.content}</TEXTAREA>
					</td>
				</tr>
